...
//=============================================================================
  ...
  auto can(MakeCanvas("fpPb_UE_Xi_Cent", 700, 600));
  ...
  tex->DrawLatex(0.16, 0.27, "#Xi^{-} + #bar{#Xi}^{+} in perp. cone");
  tex->DrawLatex(0.16, 0.17, "#it{R}(#Xi, jet) < 0.4, |#eta_{#Xi}| < 0.75");

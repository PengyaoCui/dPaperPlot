...
//=============================================================================
  ...
  auto can(MakeCanvas(Form("pp_JE_Omega")));
  can->SetLogy();
  ...
  tex->DrawLatex(0.16, 0.4, Form("#Omega^{-} + #bar{#Omega}^{+} in jets, UE subtracted"));

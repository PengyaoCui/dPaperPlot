...
//=============================================================================
  ...
  TString stny("d#it{#rho}/d#it{p}_{T}: #Lambda + #bar{#Lambda}");

  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  
  auto can(MakeCanvas(Form("f11_2")));
  can->SetLogy();
  ...
  tex->DrawLatex(0.16, 0.82, Form("Inclusive #Lambda + #bar{#Lambda}"));

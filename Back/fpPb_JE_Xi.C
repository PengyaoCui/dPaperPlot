...
//=============================================================================
  ...
  auto l = (TList*)f->Get(Form("Xi_0100"));
  f->Close();
...
//=============================================================================
  ...
  auto can(MakeCanvas(Form("pPb_JE_Xi")));
  can->SetLogy();
  ...
  tex->DrawLatex(0.46, 0.4, Form("#Xi^{-} + #bar{#Xi}^{+} in jets, UE subtracted"));
  tex->DrawLatex(0.46, 0.3, "#it{R}(#Xi, jet) < 0.4, |#eta_{#Xi}| < 0.75");

...
void fpPb_JE_XLRatio(){
//=============================================================================

  TList* l; TFile *f;
  f = TFile::Open("./data/pPb.root", "read");
  l = (TList*)f->Get(Form("Xi_toLRatio_0100"));
  f->Close();
  ...
  for (auto i=0; i<nm; ++i){ 
    hm[i] = (TH1D*)(RatioXL(i, sd, sj, "JC04", "PC04"));
    g[i] = new TGraph(hm[i]);
...
//=============================================================================
  ...
  auto can(MakeCanvas("pPb_JE_XLRatio", 700, 600));
  ...
  tex->DrawLatex(0.44, 0.9, "ALICE p-Pb #sqrt{#it{s}_{NN}} = 5.02 TeV");

...
void fpPb_UE_LKRatio_Cent(){
  ...
  for(Int_t i = 0; i<5; i++){
    h[i] = (TH1D*)l[i]->FindObject(Form("hUER"));
    gE[i] = (TGraphErrors*)l[i]->FindObject(Form("UERerr"));
  }

//=============================================================================
  auto dflx(0.), dfux(12.);
  auto dfly(0.), dfuy(1.4);
  ...
  tex->DrawLatex(0.16, 0.9, "ALICE p-Pb #sqrt{#it{s}_{NN}} = 5.02");
  ...
  tex->DrawLatex(0.16, 0.6, "Particles in perp. cone");

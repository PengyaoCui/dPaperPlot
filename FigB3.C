...
void FigB3(){
  ...
  for(int p = 0; p<np; p++ ){
    l[p] = (TList*)f->Get(Form("%s_40100", sp[p].Data()));
...
//=============================================================================
  ...
  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  auto can(MakeCanvas("FigB3", 1000, 350));
//=====Make pads===============================================================
  ...
  TEX->DrawLatex(0.16, 0.025, stnx);
  TEX->DrawLatex(0.48, 0.025, stnx);
  TEX->DrawLatex(0.80, 0.025, stnx);

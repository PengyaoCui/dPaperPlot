...
void fpPb_JE_OKRatio(){
//=============================================================================

  TList* l; TFile *f;
  f = TFile::Open("./data/pPb.root", "read");
  l = (TList*)f->Get(Form("Omega_toKRatio_0100"));
  f->Close();
  ...
  for (auto i=0; i<nm; ++i){ 
    hm[i] = (TH1D*)(RatioOK(i, sd, sj, "JC04", "PC04"));
    g[i] = new TGraph(hm[i]);
...
//=============================================================================
  ...
  auto can(MakeCanvas("pPb_JE_OKRatio", 700, 600));

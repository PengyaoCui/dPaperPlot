...
void f08_4(){
  ...
  auto l = (TList*)f->Get("Xi_toLRatio_0100");
  f->Close();
...
//=============================================================================
  ...
  tex->DrawLatex(0.16, 0.9, "ALICE p-Pb #sqrt{#it{s}_{NN}} = 5.02 TeV, 0-100%");
  ...
  //tex->DrawLatex(0.16, 0.82, "#frac{#Xi^{-} + #bar{#Xi}^{+}}{#Lambda + #bar{#Lambda}}");

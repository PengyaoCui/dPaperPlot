...
//=============================================================================
  ...
  TString stny("d#it{#rho}/d#it{p}_{T}: #Omega^{-} + #bar{#Omega}^{+}");

  
  SetStyle(kTRUE);
  gStyle->SetErrorX(0);
  
  auto can(MakeCanvas(Form("f11_4")));
  can->SetLogy();
  ...
  tex->DrawLatex(0.16, 0.82, Form("Inclusive #Omega^{-} + #bar{#Omega}^{+}"));

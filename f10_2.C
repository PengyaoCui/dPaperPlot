...
void f10_2(){
  ...
  TList* l[4];
  l[0]= (TList*)f->Get(Form("Lambda_sum_0100"));
  l[1]= (TList*)f->Get(Form("Lambda_sum_010"));
  l[2]= (TList*)f->Get(Form("Lambda_sum_1040"));
  l[3]= (TList*)f->Get(Form("Lambda_sum_40100"));
  f->Close();
...
//=============================================================================
  ...
  tex->DrawLatex(0.16, 0.82, Form("#Lambda + #bar{#Lambda} in jet"));

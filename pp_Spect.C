...
//=====Make pads===============================================================
  ...
  TPad *pad2 = new TPad("pad2", "pad2", 0.51, 1., 1., 0.51);
  pad2->Range(0., 0., 1., 1.);
  pad2->SetFillColor(0);
  ...
  TPad *pad3 = new TPad("pad3", "pad3", 0., 0.51, 0.51, 0.);
  pad3->Range(0., 0., 1., 1.);
  pad3->SetFillColor(0);
  ...
  TPad *pad4 = new TPad("pad4", "pad4", 0.51, 0.51, 1., 0.);
  pad4->Range(0., 0., 1., 1.);
  pad4->SetFillColor(0);
  ...
  tex->DrawLatex(0.22, 0.94, "ALICE pp #sqrt{#it{s}} = 13 TeV");
  tex->DrawLatex(0.76, 0.94, "Particle:|#eta| < 0.75");
  tex->DrawLatex(0.26, 0.45, "Jet: anti-#it{k}_{T}, #it{R} = 0.4");
  tex->DrawLatex(0.29, 0.4, "#it{p}_{T, jet}^{ch} > 10 GeV/#it{c}");
  tex->DrawLatex(0.35, 0.35, "|#eta_{jet}| < 0.35");

  tex->DrawLatex(0.25, 0.02, stnx);
  tex->DrawLatex(0.73, 0.02, stnx);
  
  tex->DrawLatex(0.125, 0.6, "K^{0}_{S}");
  tex->DrawLatex(0.585, 0.6, "#Lambda + #bar{#Lambda}");
  tex->DrawLatex(0.125, 0.125, "#Xi^{-} + #bar{#Xi}^{+}");
  tex->DrawLatex(0.585, 0.125, "#Omega^{-} + #bar{#Omega}^{+}");
